<footer class="footer">
    ...
    <div class="footer-inner">
        ...
        <div>
            <h3>Rigel Foundation Archive</h3>
            <p>Official archive portal for reports, certificates, and public records.</p>
        </div>
    ...
    <div class="footer-bottom">
        © <?php echo date("Y"); ?> Rigel Foundation Archive. All rights reserved.
    </div>
